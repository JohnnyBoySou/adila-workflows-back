...
export const runWorkflowBody = t.Optional(
  t.Object({
    ...
    // Modo debug: o engine para após executar o nó com este id e devolve o
    // output dele como resultado final do run. Útil pro "play até aqui" do
    // editor — geralmente combinado com pinnedData nos nós upstream.
    stopAtNodeId: t.Optional(t.String()),
